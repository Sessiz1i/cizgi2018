<%@ Page Title="" Language="C#" MasterPageFile="~/cizgi.master" AutoEventWireup="true" CodeFile="cardtest2.aspx.cs" Inherits="cardtest2" %>
...
<%--                     <div class="form-group">
                ...
                <div class="form-group" id="halkbankSecimler" runat="server" Visible="False">
                    <div class="col-sm-3">
                        <p style="font-size: 20px; margin-top:5px">Halkbank İçin Taksit Seçenekleri</p>
                    </div>
